...
class Interest {
    ...
    static func createInterests() -> [Interest] {
        return [
            ...
            Interest(title: "It's about being better than you used to be", description: "Running is not about being better than someone else. 🐧⛺️✨", featuredImage: UIImage(named: "run")!),
        ]
    }
